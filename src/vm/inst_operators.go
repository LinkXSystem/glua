...
// R(A) := RK(B) op RK(C)
// luac -1 - : local a,b,c,d,e; e = b + 100
...
// luac -1 - : local a,b,c,d,e; a = (b == "foo")
...
// R(A) := not R(B)
// luac -1 - : local a,b,c,d,e; d = not b
...
// luac -1 - : local a,b,c,d,e; b = d and e
...
// luac -1 - : local a,b,c,d,e; b = b and e
